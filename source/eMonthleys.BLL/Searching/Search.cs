...
namespace eMonthleys.BLL
{
    public class Search : BaseBLL
    {
        ...
        private static Search GetSearchValuesFromiSearch(iSearch record)
        {
            if (record == null)
                return null;
            else
        ...
        private static List<Search> GetSearchListFromiSearch(List<iSearch> recordset)
        {
            if (recordset == null)
                return null;
            else
            {
                List<Search> bv = new List<Search>();
                foreach (iSearch record in recordset)
                    bv.Add(GetSearchValuesFromiSearch(record));
                return bv;
            }
        }
        # endregion
        ...
        public static List<Search> GetAllSearch(string WherePath)
        {
            List<Search> s = GetSearchListFromiSearch(SearchBase.Instance.SelectAll(WherePath));
            return s;
        }
