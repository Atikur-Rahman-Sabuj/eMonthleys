<%@ Page Title="Thanks" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="thanks.aspx.cs" Inherits="eMonthleys.thanks" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <article class="col-md-6 mainpanel">
            ...
            <section>
                <article>
                    Thanks for registering with eMonthlies.com. Your registration is pending approval and will reviewed within 24 - 48 hours.
                </article>
                <article>
                    <asp:HyperLink ID="LnkPostAd" runat="server" Text="Post an ad now" NavigateUrl="~/Account/AddVehicle.aspx"></asp:HyperLink>
                </article>
            </section>
        </article>
        <article class="col-md-3">
