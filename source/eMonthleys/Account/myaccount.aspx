<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="myaccount.aspx.cs" Inherits="eMonthleys.myaccount" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid mainpanel">
        <h1>My Account</h1>
        <ul>
            <li><a href="MyVehicles.aspx" target="_self">View my vehicles list</a></li>
            <li><a href="profile.aspx" target="_self">My Profile</a></li>
        </ul>
    </div>
</asp:Content>
